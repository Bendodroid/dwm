...
static const char *fonts[]          = { "SF Mono Powerline:pixelsize=11:antialias=true:autohint=true" };
...
static const char *dmenucmd[] = { "dmenu_run_history", "-m", dmenumon, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
